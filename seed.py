...
def seed_options(session: Session):
    ...
    options_data = [
        ...
        (2, "Les locaux et les moyens à disposition", "The buildings and resources available", None), 
        ...
        (7, "La disponibilité du Responsable Pédagogique", "Availability of the Academic Advisor", None),
        (7, "L'accompagnement du Responsable Pédagogique", "Support from the Academic Advisor", None ),
        (11, "Oui", "Yes", 1),
        (11,  "Non", "No", 0),
        ...
        (13, "L'organisation des séances et du module", "The organization of the sessions and of the module", None),
        (13, "Les pré-requis et les objectifs du module", "The prerequisites and objectives of the module", None),
        (13, "Les ressources pédagogiques mises à disposition", "The teaching resources made available", None),
        (13, "Les évaluations associées au module", "The assessments associated with the module", None),
        (13, "L'intérêt du module dans le cursus", "The relevance of the module in the program", None),
        (13, "Les explications et les retours de l'enseignant", "The teacher's explanations and feedback", None),
        (13, "L'implication et la disponibilité de l'enseignant", "The teacher's involvement and availability", None),
        (13, "L'attitude professionnelle et juste de l'enseignant", "The teacher's professional and fair attitude", None),
    ]
